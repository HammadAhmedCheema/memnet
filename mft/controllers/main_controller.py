...
import os
import json
from mft.views.main_window import MainWindow
from mft.controllers.file_import_worker import FileImportWorker
from mft.controllers.vol_scan_worker import VolScanWorker
from mft.controllers.ai_worker import AIWorker
from mft.controllers.specialist_worker import SpecialistWorker
from mft.controllers.vad_worker import VadCacheWorker
from mft.forensics.tor_analyzer import TorAnalyzer
from mft.constants.plugin_map import PLUGIN_MAP
from mft.models.database import init_db, insert_scan_result, cleanup_session_db
...
class MainController:
    ...
    def plugin_finished(self, worker, plugin_name, results, params, view_widget):
        try:
            ...
            from mft.models.database import insert_scan_result
    ...
    def init_ai_chat(self):
        ...
        from mft.models.database import get_all_scan_results
    ...
    def handle_chat_sent(self):
        ...
        from mft.controllers.ai_chat_worker import AIChatWorker
    ...
    def run_tor_scout(self):
        from mft.controllers.specialist_worker import TorScoutWorker
